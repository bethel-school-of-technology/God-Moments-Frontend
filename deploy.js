...
function createRemoteTempFolder() {
  return ssh.execCommand(
    'rm -rf godMoments-temp && mkdir godMoments-temp', {
      cwd: '/home/ubuntu'
  });
}
...
function updateRemoteApp() {
  return ssh.execCommand(
    'mkdir godMoments && cp -r godMoments-temp/* godMoments/ && rm -rf godMoments-temp', {
      cwd: '/home/ubuntu'
  });
}
...
function restartRemoteServices() {
  return ssh.execCommand(
    'cd godMoments && sudo service mongod start && pm2 start app.js', {
      cwd: '/home/ubuntu'
  });
}
...
function sshConnect() {
  ...
  ssh
    ...
    .then(function() {
      console.log('Creating `godMoments-temp` folder.');
